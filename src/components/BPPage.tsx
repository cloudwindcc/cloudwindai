...
export const BPPage: React.FC = () => {
    ...
    const fundingChartRef = useRef<HTMLCanvasCanvasElement>(null);
        ...
        <div className="antialiased pt-16" style={{ fontFamily: "'Noto Sans HK', sans-serif", backgroundColor: '#f8f9fa', color: '#343a40' }}>
            <main>
                ...
                <div className="container mx-auto px-6 pt-8">
                    <button 
                        onClick={() => navigate('/')} // Navigate to the home page (root path)
                        className="inline-flex items-center px-4 py-2 bg-sky-600 text-white rounded-lg shadow-md hover:bg-sky-700 transition-colors duration-300 text-lg font-semibold"
                    >
                        <ArrowLeft className="w-5 h-5 mr-2" /> 返回主頁
                    </button>
                </div>
                ...
                <section id="team" className="py-20">
                    <div className="container mx-auto px-6">
                        ...
                        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                            ...
                            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 text-center">
                                <img src="" alt="CTO Yifan" className="w-32 h-32 rounded-full mx-auto mb-4 ring-4 ring-white object-cover" />
                                <h4 className="text-xl font-bold">Edward</h4>
                                <p className="text-sky-800 font-semibold mb-2">首席技術官 (CTO)</p>
                                <p className="text-gray-600">負責產品架構、技術路線規劃、研發團隊管理及前沿技術預研。</p>
                            </div>
                            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 text-center">
                                <img src="" alt="CMO Mary" className="w-32 h-32 rounded-full mx-auto mb-4 ring-4 ring-white object-cover" />
