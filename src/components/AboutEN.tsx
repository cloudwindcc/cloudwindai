...
export const AboutEN: React.FC = () => {
  ...
  const team = [
    { role: "Strategy & Execution Lead", expertise: "Company strategy, business consulting, client relationships, and financing coordination", avatar: "01" },
    { role: "Technology & AI Architecture Lead", expertise: "AI architecture, product development, technical roadmap, and delivery quality", avatar: "02" },
    { role: "Market & Growth Lead", expertise: "Brand building, market expansion, customer growth, and channel partnerships", avatar: "03" }
  ];
  ...
  return (
    <section id="about" className="content-section" style={{
      ...
      <div className="text-center mb-12">
        <h2 className="text-3xl md:text-4xl font-bold mb-4 text-sky-300">About CloudWind AI</h2>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-12">
        <div className="bg-gray-800/50 p-8 rounded-xl">
          <h3 className="text-xl md:text-2xl font-bold text-sky-400 mb-4">Our Mission</h3>
        ...
        <div className="bg-gray-800/50 p-8 rounded-xl">
          <h3 className="text-xl md:text-2xl font-bold text-sky-400 mb-4">Core Advantages</h3>
      ...
      <div className="bg-gradient-to-r from-sky-900/30 to-purple-900/30 p-8 rounded-xl">
        <h3 className="text-xl md:text-2xl font-bold text-center mb-8 text-sky-300">Core Team Functions</h3>
      ...
      <div className="mt-12 bg-gradient-to-r from-green-900/20 to-blue-900/20 p-8 rounded-xl">
        <h3 className="text-xl md:text-2xl font-bold text-center mb-6 text-green-300">Customer Success Cases</h3>
        <div className="grid md:grid-cols-3 gap-6 text-center">
          <div>
            <div className="text-xl font-bold text-green-400">Retail Industry</div>
          ...
          <div>
            <div className="text-xl font-bold text-blue-400">Manufacturing Industry</div>
            <div className="text-sm text-gray-300">AI quality inspection system in a factory, defect rate decreased by 60%</div>
          </div>
          <div>
            <div className="text-xl font-bold text-purple-400">Financial Industry</div>
